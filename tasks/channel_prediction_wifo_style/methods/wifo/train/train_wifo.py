"""Method-local wrapper for the original WiFo training/evaluation loop."""
...
def _print_help_if_requested() -> bool:
    ...
    parser = argparse.ArgumentParser(
        description="Run the original WiFo training/evaluation loop. Full execution requires dependencies from requirements.txt."
    )
